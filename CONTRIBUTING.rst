...
or Miniconda_::
    ...
    conda create -n CONTRA_GOAPP python=3 six virtualenv pytest pytest-cov
    conda activate CONTRA_GOAPP
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/CONTRA_GOAPP.git
    cd CONTRA_GOAPP
...
#. Install |pre-commit|_::
   ...
   ``CONTRA_GOAPP`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/CONTRA_GOAPP
.. _issue tracker: https://github.com/<USERNAME>/CONTRA_GOAPP/issues
.. <-- end -->
