...
import os
from tkinter import Button, Canvas, Entry, Text, Tk
...
def ContraGO_Estimate_Module():
    ...
    canvas.create_rectangle(0.0, 0.0, 1440.0, 1024.0, fill="#AEC0FF", outline="")

    canvas.create_rectangle(0.0, 0.0, 1440.0, 74.0, fill="#6A79FD", outline="")

    canvas.create_rectangle(21.0, 138.0, 529.0, 1005.0, fill="#6A79FD", outline="")

    canvas.create_rectangle(21.0, 84.0, 395.0, 129.0, fill="#6A79FD", outline="")

    canvas.create_rectangle(598.0, 84.0, 972.0, 129.0, fill="#6A79FD", outline="")

    canvas.create_rectangle(598.0, 138.0, 1420.0, 1005.0, fill="#6A79FD", outline="")

    # Entry_1 Label And Entry Field
    entry_1 = Entry(bd=0, bg="#FFFFFF", highlightthickness=0)
    entry_1.place(x=80.0, y=205.0, width=356.0, height=34.0)
    ...
    entry_2.place(x=622.0, y=645.0, width=181.0, height=37.0)
    ...
    entry_3.place(x=622.0, y=766.0, width=181.0, height=37.0)
    ...
    entry_4.place(x=857.0, y=645.0, width=181.0, height=37.0)
    ...
    entry_5.place(x=1093.0, y=645.0, width=181.0, height=37.0)
    ...
    entry_6.place(x=622.0, y=205.0, width=773.0, height=373.0)
    ...
    entry_7.place(x=75.0, y=309.0, width=361.0, height=39.0)
    ...
    entry_8.place(x=75.0, y=428.0, width=361.0, height=39.0)
    ...
    entry_9.place(x=75.0, y=554.0, width=361.0, height=39.0)
    ...
    entry_10.place(x=75.0, y=663.0, width=361.0, height=39.0)
    ...
    entry_11.place(x=73.0, y=772.0, width=361.0, height=39.0)
    ...
    button_1.place(x=622.0, y=881.0, width=237.0, height=63.0)
